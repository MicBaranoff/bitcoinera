(function (window, document, console) {
    ...
    window.intgrtn.options = {
        server: {
            host: scriptUrlParser ? scriptUrlParser.hostname : "bitcoinevotech.com",
            endpoint: scriptUrlParser ? "//" + scriptUrlParser.hostname : "//bitcoinevotech.com",
    ...
    window.intgrtn.loadjscssfile(window.intgrtn.options.server.endpoint + "/sdk.css?v=" + window.intgrtn.getVersion(), "css");
